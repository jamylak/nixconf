  ...
  programs.plasma = lib.mkIf isNixos {
    ...
    shortcuts = {
      ...
      "kwin" = {
        ...
        "KrohnkiteDecrease" = "Ctrl+Alt+H";
        "KrohnkiteFloatAll" = [ ];
        "KrohnkiteFloatingLayout" = [ ];
        "KrohnkiteFocusDown" = [ ];
        "KrohnkiteFocusLeft" = [ ];
        "KrohnkiteFocusNext" = "Ctrl+Alt+F";
        "KrohnkiteFocusPrev" = "Ctrl+Alt+B";
        "KrohnkiteFocusRight" = [ ];
        "KrohnkiteFocusUp" = [ ];
        "KrohnkiteGrowHeight" = [ ];
        ...
        "KrohnkiteRotate" = [ ];
        "KrohnkiteRotatePart" = [ ];
        "KrohnkiteSetMaster" = "Ctrl+Alt+Return";
        "KrohnkiteShiftDown" = [ ];
        "KrohnkiteShiftLeft" = [ ];
        "KrohnkiteShiftRight" = [ ];
        "KrohnkiteShiftUp" = [ ];
        ...
        "KrohnkiteTileLayout" = [ ];
        "KrohnkiteToggleFloat" = "Ctrl+Alt+T";
